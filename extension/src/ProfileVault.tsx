...
export default function ProfileVault() {
  ...
  if (error) throwNormalized(error);
      ...
      const coverLetterDoc = resumes?.find((r: any) => r.type === 'cover_letter');
  ...
  return (
    <div style={{ background: '#FFFFFF', borderRadius: '1.5rem', padding: '2rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <h2 style={{ fontSize: '1.4rem', fontWeight: 700, color: '#111827' }}>Profile Vault</h2>
        {isAuthenticated && (
      ...
      <div className="uswift-card">
        <label style={{ fontWeight: 600, display: 'block', marginBottom: 8 }}>Resume</label>
        <textarea 
          value={resume} 
      ...
      <div className="uswift-card">
        <label style={{ fontWeight: 600, display: 'block', marginBottom: 8 }}>Cover Letter</label>
        <textarea 
          value={coverLetter} 
      ...
      <div className="uswift-card">
        <label style={{ fontWeight: 600, display: 'block', marginBottom: 8 }}>Q&A Profile</label>
        <textarea 
          value={qaProfile} 
