...
import { AutoApplyStatus, FeaturePage, PopupPage } from "./types/popup";

const ProfileVault = lazy(() => import("./ProfileVault"));
const JobTracker = lazy(() => import("./JobTracker"));
const ChatInterface = lazy(() => import("./ChatInterface"));
const ResumeEnhancement = lazy(() => import("./ResumeEnhancement"));
const CoverLetterGenerator = lazy(() => import("./CoverLetterGenerator"));
const FileManager = lazy(() => import("./FileManager"));
const JobAnalysis = lazy(() => import("./JobAnalysis"));
const InterviewPrep = lazy(() => import("./InterviewPrep"));

const FEATURE_COMPONENTS: Record<
  FeaturePage,
...
const FEATURE_LABELS: Record<FeaturePage, string> = {
...
export default function Popup() {
  ...
  if (page !== "home") {
    ...
    return (
      <FeaturePageShell onBack={() => setPage("home")} onSignOut={signOut}>
        <Suspense
          fallback={
            <div
              style={{
