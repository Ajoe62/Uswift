...
export declare abstract class PaymentGateway {
     ...
     */
    abstract createCheckoutSession(input: CheckoutSessionInput): Promise<CheckoutSessionOutput>;
    /**
     * Create a customer portal session (manage billing)
     */
    abstract createPortalSession(input: PortalSessionInput): Promise<PortalSessionOutput>;
    /**
     * Create a payment intent (for custom Payment Element integration)
     */
    abstract createPaymentIntent(input: PaymentIntentInput): Promise<PaymentIntentOutput>;
    /**
     * Process a refund
     */
     ...
     */
    abstract getOrCreateCustomer(userId: string, email: string, metadata?: Record<string, string>): Promise<Customer>;
    /**
     ...
     */
    abstract verifyWebhookEvent(headers: Record<string, string>, rawBody: string | Buffer): Promise<WebhookEvent>;
    /**
     ...
     * Cancel subscription
     */
    abstract cancelSubscription(externalSubId: string, cancelAtPeriodEnd?: boolean): Promise<any>;
    /**
     * Update subscription (change plan, proration)
     */
    abstract updateSubscription(externalSubId: string, newPriceId: string, prorationBehavior?: 'create_prorations' | 'none' | 'always_invoice'): Promise<any>;
}
/**
