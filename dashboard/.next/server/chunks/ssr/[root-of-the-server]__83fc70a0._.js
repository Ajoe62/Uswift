...
function ResetPasswordPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            if (token) {
                const { error: setErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.setSession({
                    access_token: token,
                    refresh_token: ""
                });
                if (setErr) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__83fc70a0._.js.map