...
export default function ResetPasswordPage() {
  ...
  return (
    <main className="max-w-md mx-auto mt-16 p-8 bg-white/95 rounded-xl shadow-lg card-magic--glow">
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold mb-2 text-uswift-navy">Reset your password</h1>
      ...
      <form onSubmit={handleSubmit} className="grid gap-4">
        <label className="block">
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border border-gray-200 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-uswift-accent"
            required
          />
        </label>
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-2 inline-flex w-full items-center justify-center rounded-md bg-uswift-accent text-white px-4 py-2 font-semibold hover:brightness-95 disabled:opacity-60"
        >
