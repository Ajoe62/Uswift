        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Automate your job applications and land your dream job faster with AI-powered automation.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                className="w-9 h-9 bg-gray-100 hover:bg-blue-600 hover:text-white rounded-lg flex items-center justify-center transition-colors duration-200 text-gray-600"
              >
          ...
          {/* Product Links */}
          <div>
            <h3 className="text-gray-900 font-semibold text-lg mb-4">Product</h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/extension" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Chrome Extension
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/security" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Security
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link href="/accessibility" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                Accessibility
              </Link>
              <Link href="/status" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                Status
              </Link>
            </div>
          </div>
