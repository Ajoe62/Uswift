        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/dashboard" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link href="/extension" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  Chrome Extension
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/security" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  Security
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-slate-700">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              <Link href="/sitemap" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                Sitemap
              </Link>
              <Link href="/accessibility" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                Accessibility
              </Link>
              <Link href="/status" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                Status
              </Link>
            </div>
          </div>
